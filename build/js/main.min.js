...
/* harmony import */ var _modules_disabled__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/disabled */ "./js/modules/disabled.js");
/* harmony import */ var _modules_selected__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/selected */ "./js/modules/selected.js");
/* harmony import */ var _modules_init_video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-video */ "./js/modules/init-video.js");
/* harmony import */ var _modules_adding_text__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/adding-text */ "./js/modules/adding-text.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_disabled__WEBPACK_IMPORTED_MODULE_1__["becomeDisabled"])();
    Object(_modules_selected__WEBPACK_IMPORTED_MODULE_2__["getSelectCard"])();
    Object(_modules_selected__WEBPACK_IMPORTED_MODULE_2__["hoverCard"])();
    Object(_modules_init_video__WEBPACK_IMPORTED_MODULE_3__["initVideo"])();
    Object(_modules_adding_text__WEBPACK_IMPORTED_MODULE_4__["addText"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_5__["sliderTrainers"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_5__["removeNotJs"])();
    Object(_modules_slider__WEBPACK_IMPORTED_MODULE_5__["sliderAdvt"])();
  });
});

/***/ }),

/***/ "./js/modules/adding-text.js":
/*!***********************************!*\
  !*** ./js/modules/adding-text.js ***!
  \***********************************/
...
var openParagraph = document.querySelectorAll('[data-features="paragraph"]');
var paragraphButton = document.querySelectorAll('[data-features="button"]');
function addText() {
  ...
  for (var i = 0; i < openParagraph.length; i++) {
    var _ret = _loop(i);
...
/***/ "./js/modules/disabled.js":
/*!********************************!*\
  !*** ./js/modules/disabled.js ***!
  \********************************/
/*! exports provided: becomeDisabled */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "becomeDisabled", function() { return becomeDisabled; });
var description = document.querySelectorAll('[data-description]');
var items = document.querySelectorAll('[data-item]');
function becomeDisabled() {
  var disabledDescriptions = ['фуа-гра', 'рыбой', 'курой'];
  for (var i = 0; i < items.length; i++) {
    if (items[i].classList.contains('disabled')) {
      description[i].innerHTML = "\u041F\u0435\u0447\u0430\u043B\u044C\u043A\u0430, \u0441 ".concat(disabledDescriptions[i], " \u0437\u0430\u043A\u043E\u043D\u0447\u0438\u043B\u0441\u044F.");
    }
  }
}
...
/* harmony import */ var _media_video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../media/video */ "./media/video.js");
/* harmony import */ var _media_video__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_media_video__WEBPACK_IMPORTED_MODULE_0__);

var initVideo = function initVideo() {
  var player = document.querySelector('[data-video-player]');
  var link = document.querySelector('[data-video-btn]');
  var boxVideo = document.querySelector('[data-video]');
  if (!link) {
    return;
  } else {
    link.addEventListener('click', function (evt) {
      ...
      if (boxVideo) {
        ...
        new YT.Player(player, {
          ...
          video: _media_video__WEBPACK_IMPORTED_MODULE_0__["video"]
        });
        evt.stopPropagation();
      }
    });
...
/***/ "./js/modules/selected.js":
/*!********************************!*\
  !*** ./js/modules/selected.js ***!
  \********************************/
/*! exports provided: getSelectCard, hoverCard */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSelectCard", function() { return getSelectCard; });
...
var descriptions = ['Печень утки разварная с артишоками.', 'Головы щучьи с чесноком да свежайшая сёмгушка.', 'Филе из цыплят с трюфелями в бульоне.'];
  ...
  var _loop = function _loop(i) {
    if (items[i].classList.contains('disabled')) {
      ...
      selectItem.addEventListener('click', function (evt) {
        evt.preventDefault();
        var toggle = selectItem.classList.toggle('selected');
        if (toggle) {
          description[i].innerHTML = "".concat(descriptions[i]);
        } else {
...
function handler(evt) {
  ...
  if (evt.type === 'mouseout') {
    for (var _i = 0; _i < items.length; _i++) {
      if (items[_i].classList.contains('selected')) {
        title[_i].innerHTML = 'Сказочное заморское яство';
        title[_i].style.color = '#666666';
      }
    }
  }
}
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: sliderTrainers, removeNotJs, sliderAdvt */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sliderTrainers", function() { return sliderTrainers; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeNotJs", function() { return removeNotJs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sliderAdvt", function() { return sliderAdvt; });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.esm.js");

var swiperButtons = document.querySelectorAll('[data-swiper-button]');
var swiperContainer = document.querySelectorAll('[data-swiper]');
var sliderTrainers = function sliderTrainers() {
  ...
  if (viewport < 700) {
    if (!swiperContainer || !swiperButtons) {
      ...
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper="features"]', {
...
var sliderAdvt = function sliderAdvt() {
  var viewport = window.innerWidth;
  if (viewport < 700) {
    if (!swiperContainer || !swiperButtons) {
      return;
    } else {
      var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('[data-swiper="advt"]', {
        modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_0__["Pagination"]],
        direction: 'horizontal',
        watchOverflow: true,
        loop: true,
...
var removeNotJs = function removeNotJs() {
  if (!swiperButtons || !swiperContainer) {
    return;
  }
  swiperButtons.forEach(function (el) {
    return el.classList.remove('is-not-js');
  });
  swiperContainer.forEach(function (el) {
    return el.classList.remove('is-not-js');
  });
};
...
var scriptUrl = 'https://www.youtube.com/s/player/34f9b71c/www-widgetapi.vflset/www-widgetapi.js';
